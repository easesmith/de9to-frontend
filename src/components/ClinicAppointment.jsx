...
const ClinicAppointment = ({ clinic, dentistId, dentistDetails }) => {
    const { clinicPhotos, clinicName, clinicAddress, city, nearbyLandmark, clinicLogo, state, clinicPincode, consultationfee, area } = clinic || {};
                ...
                <div className='border-2 max-[500px]:border border-l-transparent border-[#5B5B5B] rounded-tr-md rounded-br-md px-4 grid grid-cols-[28%_70%] gap-[2%] max-[700px]:grid-cols-1 py-2'>
                    ...
                    <div>
                        ...
                        <div className="flex justify-between gap-2">
                            ...
                            <Button onClick={handleMapSearch} variant="outline" className="flex gap-2 mt-2 text-[#717171] border-[#717171] hover:text-[#939292]">
                        ...
                        <p className='font-inter text-sm text-[#717171] my-2'><span className='font-bold'>Area:</span>  {area}</p>
