...
const SlotSection = ({ title, slots, selectedSlot, handleSlotClick, dayDate }) => (
    <div className="grid w-full gap-3 max-h-[200px] overflow-y-auto">
            ...
            <div className="grid grid-cols-4 w-full gap-2">
                {slots.map((slot, slotIndex) => (
                    <Button
                        ...
                        key={slotIndex}
                        variant="secondary"
                        className={`border-2 hover:scale-100 ${selectedSlot === slot?.slotId?.startTime ? 'bg-[#95C22B] hover:bg-[#95C22B] text-white' : ''}`}
