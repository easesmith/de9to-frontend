                ...
                <div className='p-4 rounded-[6px] h-full flex max-[700px]:flex-col gap-[10px] shadow-lg'>
                    ...
                    <div className=' h-full ps-[9px] max-[500px]:px-0 flex flex-col items-start justify-between max-[900px]:w-full w-[calc(100%-210px)]'>
                        <div>
                            <div className='flex items-center max-[500px]:flex-col max-[500px]:items-start max-[500px]:justify-start max-[500px]:gap-0 justify-between gap-4'>
                                <div className='flex items-center gap-4'>
                                    <h4 className='text-[#1A1A1A] text-2xl max-[500px]:base font-semibold font-inter'>{clinic?.clinicName}</h4>
                                    <Button onClick={handleMapSearch} variant="outline" size="sm" className="flex gap-2 max-[1045px]:hidden text-[#95C22B] border-[#95C22B] hover:text-[#95C22B]">
                                ...
                                <div>
                                    ...
                                    <div className='text-[#000000] text-[10px] text-right max-[500px]:text-left font-normal font-inter'>Rated by {clinicRating?.length} users</div>
                                </div>
                            </div>
                        ...
                        <div className='flex gap-4 items-center mt-4'>
                            <Button variant="outline" size="sm" className="flex gap-2 max-[500px]:py-2 max-[500px]:px-2 text-[#95C22B] border-[#95C22B] hover:text-[#95C22B] max-[500px]:text-sm">
                                <MdCall className='text-[#95C22B] text-xl' />
                                <span>Call now</span>
                            </Button>
                            <Button onClick={handleMapSearch} variant="outline" size="sm" className="flex max-[500px]:py-2 max-[500px]:px-2 min-[1045px]:hidden gap-2 text-[#95C22B] border-[#95C22B] hover:text-[#95C22B]">
                                <FaLocationArrow className='text-[#95C22B]' />
                                <span>Search on map</span>
                            </Button>
                        </div>
