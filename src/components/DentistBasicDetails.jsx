                    ...
                    <div className='pe-[25px] ps-[9px] max-[500px]:px-0 gap-6 w-[calc(100%-210px)] max-[900px]:w-full'>
                        <div className='flex items-center justify-between max-[500px]:justify-start max-[500px]:items-start max-[500px]:flex-col max-[500px]:gap-0 gap-4'>
                            ...
                            <div>
                                ...
                                <div className='text-[#000000] text-[10px] max-[900px]:text-left text-right font-normal font-inter'>Rated by 2 users</div>
                            </div>
                        </div>
                        <div className='flex flex-col justify-start gap-2'>
                            <div className="flex items-center gap-2 mt-1">
                                ...
                                <div className='flex gap-2 items-center'>
                                    ...
                                    <p className='text-[#95C22B] font-inter font-semibold whitespace-nowrap max-[760px]:text-sm max-[500px]:text-xs'>Oral Pathology</p>
                                    <div className='w-[2px] h-[14px] bg-[#95C22B]'></div>
                                    <p className='text-[#95C22B] font-inter font-semibold whitespace-nowrap max-[760px]:text-sm max-[500px]:text-xs'>Dr. Narang’s Dental Hub</p>
                                </div>
                            </div>
