...
const RatingsComp = ({ allRating }) => {
    ...
    return (
        <div className='border-2 border-[#95C22B] rounded-lg bg-[#95C22B1A] px-10 max-[500px]:px-4 py-6 w-full grid grid-cols-[30%_68%] max-[900px]:grid-cols-[30%_68%] max-[700px]:grid-cols-1 gap-3'>
            <div>
