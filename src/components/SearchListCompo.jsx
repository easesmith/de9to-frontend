...
const SearchListCompo = () => {
    ...
    return (
        <section className={`max-w-[1240px] w-full mx-auto ${isShadow?'shadow-custom7':''}`}>
            <LocationCompo searchQuery={searchQuery} setSearchQuery={setSearchQuery} handleQuery={handleQuery} handleGetSerachQuery={handleGetSerachQuery} location={location} isShadow={isShadow} setLocation={setLocation} />
            <>
                    ...
                    <div className='flex flex-col gap-5'>
                        <div className='flex flex-col justify-between gap-12'>
                            ...
                            <div className='flex justify-center items-center'>
                                <p onClick={()=> setShowAllDentist(true)} className='text-[#3F3F3F] text-lg font-medium font-poppins'>{`${showAllDentist?'':'See All'}`}</p>
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col justify-between gap-12'>
                            ...
                            <div className='flex justify-center items-center'>
                                <p onClick={()=> setShowAllClinic(true)} className='text-[#3F3F3F] text-lg font-medium font-poppins'>{`${showAllClinic?'':'See All'}`}</p>
                            </div>
                        </div>
                    </div>
                </div>
