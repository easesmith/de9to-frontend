    ...
    <section className='bg-[#F4F9EA]'>
      <div className='bg-[#F4F9EA] px-5 py-16'>
        ...
        <div className=' flex justify-center items-start max-[700px]:grid max-[700px]:grid-cols-2 gap-10 max-[500px]:gap-5 flex-wrap'>
          {data.map((item, index) => (
            <div key={index} className=' w-[285px] max-[700px]:w-auto h-fit bg-[#FFFFFF] flex flex-col justify-center items-center cursor-pointer rounded-2xl shadow-custom5 p-4 group hover:scale-110 transition-all duration-200'>
              ...
              <div className=' bg-[#95C22B] max-[500px]:flex cursor-pointer justify-center items-center gap-3 border-[1px] border-[#95C22B] rounded-2xl max-[500px]:rounded-lg px-12 max-[500px]:px-4 max-[500px]:py-1 py-4 mt-10 hidden group-hover:flex'>
                <button className=' text-[#FFFFFF] text-lg max-[500px]:text-xs font-semibold font-poppins'>Learn more</button>
