    ...
    <section className='bg-[#F4F9EA]'>
      <div className='bg-[#F4F9EA] px-5 py-16'>
        ...
        <div className=' flex justify-center items-start gap-10 flex-wrap'>
          {data.map((item, index) => (
            <div key={index} className=' w-[285px] h-fit bg-[#FFFFFF] flex flex-col justify-center items-center cursor-pointer rounded-2xl shadow-custom5 p-4 group hover:scale-110 transition-all duration-200'>
