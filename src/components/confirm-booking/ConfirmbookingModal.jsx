...
const ConfirmBookingModal = ({
  ...
  return (
    <Dialog
      ...
      onOpenChange={setIsConfirmBookingModalOpen}
    >
      <DialogContent className="max-w-[700px] max-h-[90vh] overflow-y-auto w-full">
        <DialogHeader className="text-left">
          <div className="flex justify-between items-center">
            ...
            <X
              onClick={() => setIsConfirmBookingModalOpen(false)}
          ...
          <Form {...form}>
            ...
            >
              ...
              {clinic && clinic.length > 0 && (
                <div className="w-full">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="font-inter text-sm sm:text-base text-left sm:text-left">
                          Select Clinic
                        </FormLabel>
                        <FormControl>
                          <Select
              ...
              {getValues("clinic") && (
                <>
                  <Label className="font-inter text-sm sm:text-base border-b pb-2 border-b-[#71717154] w-full">
                    Select Availability
                  </Label>
