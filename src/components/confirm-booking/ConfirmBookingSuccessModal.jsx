    ...
    return (
        <AlertDialog open={isConfirmBookingSuccessModalOpen} onOpenChange={setIsConfirmBookingSuccessModalOpen}>
            <AlertDialogContent className="max-w-[400px] max-h-[90vh] overflow-y-auto w-full">
                <AlertDialogHeader>
                    <AlertDialogTitle className="font-inter font-bold text-[#009245] text-2xl">Congratulations!!</AlertDialogTitle>
                    <AlertDialogDescription className="text-base text-[#333333]"><b>DentMarc Dental Clinic</b> has received your booking. Sit back & relax, we will update you soon on your  contact info</AlertDialogDescription>
                </AlertDialogHeader>
