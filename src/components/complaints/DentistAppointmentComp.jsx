...
const DentistAppointmentComp = ({ control, setValue, getValues }) => {
    ...
    const getAppointments = () => {
        fetchData(`/admin/get-all-appointment-dentist?dentistId=${getValues("dentistId")}`)
    }
...
export default DentistAppointmentComp