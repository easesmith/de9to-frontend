...
const BlogDetail = () => {
  ...
  return (
    <Layout>
      <main className='w-[1240px] max-w-[1240px] mx-auto'>
        <div>
          <div className='w-2/3'>
            ...
            <div className=' flex flex-col gap-4'>
              <p className='text-[#717171] text-base font-normal font-inter'>The term ‘gingivitis’ comes from the two words, ‘gingiva’, which is the medical term for gums, and ‘itis’, attached to any word indicates inflammation. Inflammation is mostly caused by the presence of a foreign body or irritation caused due to an external factor.  At times, such inflammation can also occur due to internal conditions or can be a secondary result of another disease. Gingivitis is a very common problem among the population and isn’t very critical and hence is ignored most of the time. The matter of concern here is, that gingivitis is the first stage of critical gum disease periodontitis which can lead to severe oral health issues. So, let us see how we can categorize it to understand it better.</p>
              <p className='text-[#717171] text-base font-normal font-inter'>Gingivitis can be generally classified based on the duration of its occurrence as acute (small duration) or chronic (long duration), based on the number of teeth affected as localized (affecting a single tooth or some teeth in an arch) or generalized (affecting all teeth of an arch or both dental arches).</p>
              <h4 className='text-[#717171] text-xl font-bold font-inter'>Causes : </h4>
              <ul>
                <li className='text-[#717171] text-base font-normal font-inter'>Causes of gingivitis can vary but the most common cause is the inability to clean the deposition of plaque on the teeth and surrounding areas i.e. not brushing or cleaning the teeth and mouth.  The collected plaque which contains the bacteria leads to inflammation of the tissue.</li>
                <li className='text-[#717171] text-base font-normal font-inter'>Lodging of food particles or foreign bodies such as using toothpicks, pins, etc. to pick out food. </li>
                <li className='text-[#717171] text-base font-normal font-inter'>Improper brushing techniques such as aggressive or wrong methods of brushing can lead to gingival irritation.</li>
              </ul>
              <h4 className='text-[#717171] text-xl font-bold font-inter'>Risk factors associated :</h4>
              <ul>
                <li className='text-[#717171] text-base font-normal font-inter'>Smoking or habit of tobacco chewing.</li>
                <li className='text-[#717171] text-base font-normal font-inter'>Poor oral hygiene.</li>
                <li className='text-[#717171] text-base font-normal font-inter'>Dry mouth – Less production of saliva or mouth breathing can result in dry mouth</li>
                <li className='text-[#717171] text-base font-normal font-inter'>Vitamin C deficiency</li>
                <li className='text-[#717171] text-base font-normal font-inter'>Poorly fitting dental appliances, poorly finished dental restorations, crooked teeth that are difficult to clean (malaligned teeth).</li>
              </ul>
              <h4 className='text-[#717171] text-xl font-bold font-inter'>Symptoms : </h4>
              <ul>
                <li className='text-[#717171] text-base font-normal font-inter'>A foremost and common symptom of gingivitis is bleeding gums. Bleeding from gums while brushing is often neglected.</li>
                <li className='text-[#717171] text-base font-normal font-inter'>Swollen or puffy gums.</li>
                <li className='text-[#717171] text-base font-normal font-inter'>Swollen or puffy gums.</li>
                <li className='text-[#717171] text-base font-normal font-inter'>Swollen or puffy gums.</li>
                <li className='text-[#717171] text-base font-normal font-inter'>Swollen or puffy gums.</li>
              </ul>
              ...
              <ul>
                <li className='text-[#717171] text-base font-normal font-inter'>Causes of gingivitis can vary but the most common cause is the inability to clean the deposition of plaque on the teeth and surrounding areas i.e. not brushing or cleaning the teeth and mouth.  The collected plaque which contains the bacteria leads to inflammation of the tissue.</li>
                <li className='text-[#717171] text-base font-normal font-inter'>Lodging of food particles or foreign bodies such as using toothpicks, pins, etc. </li>
                <li className='text-[#717171] text-base font-normal font-inter'>Lodging of food particles or foreign bodies such as using toothpicks, pins, etc. </li>
                <li className='text-[#717171] text-base font-normal font-inter'>Lodging of food particles or foreign bodies such as using toothpicks, pins, etc. </li>
                <li className='text-[#717171] text-base font-normal font-inter'>Lodging of food particles or foreign bodies such as using toothpicks, pins, etc. </li>
                <li className='text-[#717171] text-base font-normal font-inter'>Lodging of food particles or foreign bodies such as using toothpicks, pins, etc. </li>
              ...
              <p className='text-[#717171] text-base font-normal font-inter'>So, we hope now you know why you should never ignore bleeding gums. Our mouth is the gateway for nutrition and overall health. So let’s prevent it from any harm by practicing healthy dental habits. </p>
              <p className='text-[#717171] text-base font-normal font-inter'>-Dr.Nehal Tambe </p>
            </div>
