  ...
  const data = [
    {
      image: Img1,
      description:
        "Provide free or low-cost dental care, making oral health services accessible to everyone.",
    },
    {
      image: Img1,
      description:
    ...
    <Layout>
      <main className=" relative">
          ...
          <section className="flex items-start max-w-[1200px] gap-2 py-5  mx-auto max-large:items-center">
            <div className="left-side w-1/2 flex flex-col gap-3 max-med:w-full max-med:gap-0">
              <div className="upper flex flex-col items-start gap-2">
                ...
                <h2 className="text-[#000A2D] text-2xl font-bold font-inter max-large:text-xl">
                  Request A Dental Camp
                </h2>
                <p className="text-[#606060] text-sm font-normal font-roboto">
                  Feel free to drop a message related to your requirement.Our
              ...
              <div className="lower">
                <Form {...form}>
                  <form
                    ...
                    className="flex flex-col gap-4 max-[950px]:gap-3"
                  >
                    <div className="grid grid-cols-2 gap-4 w-full max-md:grid-cols-1 max-small:grid-cols-1 max-[950px]:gap-3">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className=" text-base font-medium font-inter mb-4 max-[950px]:text-base max-small:text-sm">
                              Organiser's Name{" "}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-[] text-base font-medium font-inter mb-4 max-med:text-base max-small:text-sm">
                    ...
                    <div className="grid grid-cols-2 gap-4 w-full max-md:grid-cols-1 max-med:grid-cols-2 max-small:grid-cols-1 max-[950px]:gap-3">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-base font-medium font-inter mb-4 max-[950px]:px-3 max-[950px]:text-sm max-[950px]:h-[46px] max-[950px]:rounded-lg">
                              Camp Perferred Date{" "}
                              <span className="text-[red]">*</span>
                            </FormLabel>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-base font-medium font-inter mb-4 max-med:text-base max-small:text-sm">
                              Camp Start Time{" "}
                              <span className="text-[red]">*</span>
                            </FormLabel>
                            <div className="relative">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-base font-medium font-inter mb-4 max-med:text-base max-small:text-sm">
                            Camp Duration <span className="text-[red]">*</span>
                          </FormLabel>
                          <div className="relative">
                            <FormControl>
                              <Select
                              ...
                              >
                                <SelectTrigger className="w-full border-[#808080] text-[#838383] text-base h-12 px-5 max-[950px]:px-3 max-[950px]:text-sm max-[950px]:h-[46px] max-[950px]:rounded-lg">
                                  <SelectValue placeholder="Select camp duration" />
                                </SelectTrigger>
                                <SelectContent>
                                  <SelectGroup>
                    ...
                    <Button
                      variant="submit"
                      size="lg"
                      className="h-[56px] max-med:text-base max-med:h-11"
                      type="submit"
                    >
                      Submit
                    </Button>
            ...
            <div className="right-side relative w-1/2 flex flex-col items-center h-[560px] max-med:hidden gap-5">
              <div className="w-[214px] h-[87px] rounded-2xl py-3 px-5 bg-[#F4F9EA] shadow-custom3 -mb-10 ml-8">
                <h5 className="text-[#000000] text-center font-normal font-poppins mb-1">
                  our professionals
                </h5>
                <div className="flex relative">
                  ...
                  />
                  <img
                    src={ProfessionalImg3}
                    alt=""
                    className="absolute left-10 z-[11]"
                  />
                  <img
                    src={ProfessionalImg4}
                    alt=""
                    className="absolute left-[60px] z-[12]"
                  />
                  <img
                    src={ProfessionalImg5}
                    alt=""
                    className="absolute left-20 z-[13]"
                  />
                  <img
                    src={ProfessionalImg6}
                    alt=""
                    className="absolute left-[100px] z-[14]"
                  />
                  <img
                    src={ProfessionalImg7}
                    alt=""
                    className="absolute left-[120px] z-[15]"
                  />
                  <div className="bg-[#95C22B] rounded-full flex justify-center items-center absolute left-[140px] z-[16] w-[37px] h-[37px]">
                    <p className="text-[#FFFFFF] text-sm font-normal font-poppins">
                      30+
                    </p>
                  </div>
                </div>
              ...
              <img
                src={RequestDentalImg}
                alt=""
                className="relative object-contain z-10 h-[500px] max-large:h-[700px] max-large:w-[350px] w-full"
              />
            </div>
          </section>
        </div>
        <img
          src={BackgroundImg}
          alt=""
          className="min-w-[685px] max-h-[600px] absolute top-[0%] right-[0%] -z-0 max-large:hidden"
        />
          ...
          >
            <div className="flex flex-wrap justify-between items-center gap-6 px-10 py-10 text-[#808080] w-full max-lg:justify-between max-lg:px-5 max-[425px]:px-2">
              <MangementInfo
                ...
                number={150}
                title="Dentist Signups"
              />
              <MangementInfo
                isCounter={isCounter}
                img={DentalConsultationImg}
                number={10000}
              ...
              <MangementInfo
                isCounter={isCounter}
                img={PinCodersCoveredImg}
                number={75}
                title="Pin Codes Covered"
              />
              <MangementInfo
                isCounter={isCounter}
                img={HealthWebinarImg}
                number={75}
          ...
          <div className="max-w-[1200px] mx-auto w-full flex flex-col gap-[30px]">
            <div className="upper flex items-end justify-between gap-10 w-full">
              <div className="w-full flex flex-col items-start gap-[15px] max-med:items-center max-small:gap-2">
                <span className="text-[#95C22B] text-xl font-bold font-inter max-small:text-sm">
                  Our Best Practices
                </span>
                <h2 className="text-[#000A2D] text-5xl font-bold font-inter max-large:text-4xl max-med:text-3xl max-small:text-base">
                  What Is Dental Camp?
                </h2>
                <div className="flex justify-between max-med:justify-center max-med:flex-wrap items-start w-full gap-6">
                  <p className="text-[#606060] text-xl font-semibold font-roboto w-[55%] max-large:text-lg max-med:w-full max-med:text-center max-med:text-base max-med:font-normal max-small:text-sm">
                    To create awareness and on-spot dental solutions De9to has a
                    portable setup of modern dental equipment which can be
                    installed in areas
                  </p>
                  <Button
                    variant="submit"
            ...
            <div className="lower w-full grid grid-cols-4 max-large:grid-cols-3 place-items-start justify-items-center max-med:grid-cols-2 gap-6 max-[1154px]:justify-center max-med:gap-3">
              <div className="hover:translate-y-2 max-w-[278px] h-[410px] max-lg:h-[340px] max-md:h-[320px] max-small:h-[200px] bg-[#FFFFFF] rounded-xl p-5 flex flex-col items-start justify-center gap-3 cursor-pointer max-small:gap-2 max-small:p-3">
                <img
                  src={PreventingImg}
                  alt=""
                  className="max-small:w-8 max-small:h-8"
                />
                <div className="flex flex-col items-start gap-2 max-small:gap-0">
                  <h4 className="text-[#1A1A1A] text-xl font-semibold font-inter max-large:text-lg max-med:text-base max-small:text-[10px] max-small:leading-[13px]">
                    Preventing Tooth Decay
                  </h4>
                  <p className="text-[#667085] text-base font-normal font-inter max-large:text-sm max-med:text-xs max-small:text-[8px] max-small:leading-3">
                    Regular brushing, flossing, and dental check-ups help
                    prevent cavities and tooth decay, ensuring your smile stays
                    healthy and bright.
                  </p>
                </div>
              ...
              <div className="hover:translate-y-2 max-w-[278px] h-[410px] max-lg:h-[340px] max-md:h-[320px] max-small:h-[200px] bg-[#FFFFFF] rounded-xl p-5 flex flex-col items-start justify-center gap-3 cursor-pointer max-small:gap-2 max-small:p-3">
                ...
                <div className="flex flex-col items-start gap-2 max-small:gap-0">
                  ...
                  <p className="text-[#667085] text-base font-normal font-inter max-large:text-sm max-med:text-xs max-small:text-[8px] max-small:leading-3">
                    Maintaining good oral hygiene reduces the risk of gum
                    disease, which can lead to tooth loss and other health
              ...
              <div className="hover:translate-y-2 max-w-[278px] h-[410px] max-lg:h-[340px] max-md:h-[320px] max-small:h-[200px] bg-[#FFFFFF] rounded-xl p-5 flex flex-col items-start justify-center gap-3 cursor-pointer max-small:gap-2 max-small:p-3">
                ...
                <div className="flex flex-col items-start gap-2 max-small:gap-0">
                  <h4 className="text-[#1A1A1A] text-xl font-semibold font-inter max-large:text-lg max-med:text-base max-small:text-[10px] max-small:leading-[13px]">
                    Overall Health Connect
                  </h4>
                  <p className="text-[#667085] text-base font-normal font-inter max-large:text-sm max-med:text-xs max-small:text-[8px] max-small:leading-3">
                    Oral health is closely linked to overall health; poor dental
                    hygiene can contribute to conditions like heart disease,
                    diabetes respiratory issues etc
                  </p>
                </div>
                <HiArrowLongRight className="text-2xl ms-2" />
              </div>
              ...
              <div className="hover:translate-y-2 max-w-[278px] h-[410px] max-lg:h-[340px] max-md:h-[320px] max-small:h-[200px] bg-[#FFFFFF] rounded-xl p-5 flex flex-col items-start justify-center gap-3 cursor-pointer max-small:gap-2 max-small:p-3">
                ...
                <div className="flex flex-col items-start gap-2 max-small:gap-0">
                  ...
                  <p className="text-[#667085] text-base font-normal font-inter max-large:text-sm max-med:text-xs max-small:text-[8px] max-small:leading-3">
                    Healthy teeth and gums contribute to a more attractive
                    smile, boosting self-esteem and confidence in social and
        ...
        <section className="max-w-[1240px] mx-auto my-24 max-med:my-16 w-full px-4">
          <div className="flex justify-between mb-12 w-full">
            <div className="flex flex-col items-start gap-2 max-med:items-center w-full">
              <h5 className="text-[#95C22B] text-xl italic font-bold font-inter">
                Pictures
              </h5>
              <h4 className="text-[#1A1A1A] text-[40px] font-extrabold font-inter max-large:text-3xl max-med:text-2xl max-small:text-base">
                Pick a Plan that is right for You
              </h4>
              <p className="text-[#606060] text-xl font-semibold font-roboto max-med:text-base max-small:text-xs">
                Elevating Oral Health Awareness
              </p>
            </div>
          </div>
        ...
        <section className=" my-24 max-med:my-16">
          <div className="flex justify-between mb-12 max-w-[1240px] mx-auto w-full px-5 max-sm:mb-4">
            <div className="flex flex-col items-start gap-2 max-med:items-center w-full">
              <h5 className="text-[#95C22B] text-xl italic font-bold font-inter max-med:text-base max-small:text-sm">
                Why Dental Camps?
              </h5>
              <h4 className="text-[#1A1A1A] text-[40px] font-extrabold font-inter max-large:text-3xl max-med:text-2xl max-small:text-base max-med:text-center">
                Why Dental Camps are Important
              </h4>
            </div>
          </div>
          <div className="flex gap-12 items-center overflow-hidden overflow-y-visible max-sm:gap-8 max-small:gap-2">
            {data.map((e, i) => {
              return (
                <div
                  key={i}
                  className="animate-scroll rounded-2xl bg-[#FFFFFF] flex flex-col items-center gap-5 py-3 px-2 my-2 min-w-[180px] h-[170px] shadow-lg cursor-pointer "
                >
                  <img src={e.image} alt="" className="w-[64px] h-[36px]" />
                  <p
                    className={`text-[#1A1A1A] text-center text-sm font-normal font-inter`}
                  >
                    {e.description}
                  </p>
                </div>
        ...
        <section className="w-full max-w-[1240px] mx-auto px-3">
          <div className="bg-[#95C22B] rounded-3xl flex items-start justify-center gap-20 h-full max-large:gap-8 max-med:flex-col max-med:gap-5 px-5 py-14 max-med:py-6">
            <div className="w-[327px] h-[234px] flex flex-col max-med:h-fit max-med:w-full">
              <p className="text-[#FFFFFF] text-base font-semibold font-inter max-med:text-sm mb-2">
                TESTIMONIALS
              </p>
              <h3 className="text-[#FFFFFF] text-4xl font-bold font-inter leading-[48px] max-large:text-3xl max-med:text-xl w-[85%] max-large:w-full">
                The Honest Review From Our Dentists
              </h3>
              <p className="text-[#FFFFFF] text-base font-medium font-inter max-large:text-sm w-[85%]">
                See what our dentists are saying about their experiences of our
                service
              </p>
            </div>
            ...
            <div className="max-w-[500px] w-full max-large:max-w-[430px]">
              <div className="flex justify-between items-end gap-4">
                ...
                >
                  <SwiperSlide>
                    <p className="text-[#FFFFFF] text-2xl font-bold font-inter mb-16 max-large:text-base max-med:text-sm max-med:font-normal max-med:mb-10">
                      I joined De9to with the aim of promoting oral health
                      awareness, benefiting from their free registration. My
                      experience has been excellent, resulting in revenue
                      exceeding 2.5 lac
                    </p>
                    <div className="profile flex gap-3">
                      ...
                      <div className=" flex flex-col items-start justify-start">
                        <ReactStars
                          ...
                          color2="#FFD400"
                        />
                        <h5 className="text-[#FFFFFF] text-xl font-bold font-inter max-med:text-base">
                          Dr. Jonathan Vallem
                        </h5>
                        <p className="text-[#FFFFFF] text-sm font-medium font-inter max-med:text-xs">
                          New york, USA
                        </p>
                      </div>
                    </div>
                ...
                <div className="flex justify-center items-end gap-4 max-med:hidden">
                  <div
                    className="w-[48px] h-[48px] bg-[#E1FF9A] flex justify-center items-center rounded-full cursor-pointer"
                    onClick={() => swiperRef2.current?.slidePrev()}
                  >
                    <GoArrowLeft className="text-2xl" />
                  </div>
                  <div
                    className="w-[62px] h-[62px] bg-[#FFFFFF] flex justify-center items-center rounded-full cursor-pointer"
        ...
        <section className=" flex flex-col items-center gap-10 w-full max-w-[1240px] mx-auto my-28 px-5 max-med:my-16">
          <div className="flex flex-col items-center">
            <span className="text-[#95C22B] text-xl text-center italic font-bold font-inter max-md:text-base max-sm:text-sm">
              Our Contributors
            </span>
            <h3 className="text-[#000000] text-[40px] text-center font-bold font-inter max-md:text-[30px] max-sm:text-xl">
              Our Collaborators
            </h3>
          </div>
          <div className="flex max-w-[1000px] max-sm:max-w-[450px] gap-5 justify-between w-full max-small:gap-[14px]">
            <img
              src={OurCollaboratorImg1}
              alt=""
              className="max-md:w-[130px] max-md:h-[130px] max-sm:w-[60px] max-sm:h-[60px] max-[425px]:w-[60px] max-[425px]:h-[60px]"
            />
            <img
              src={OurCollaboratorImg2}
              alt=""
              className="max-md:w-[130px] max-md:h-[130px] max-sm:w-[60px] max-sm:h-[60px] max-[425px]:w-[60px] max-[425px]:h-[60px]"
            />
            <img
              src={OurCollaboratorImg3}
              alt=""
              className="max-md:w-[130px] max-md:h-[130px] max-sm:w-[60px] max-sm:h-[60px] max-[425px]:w-[60px] max-[425px]:h-[60px]"
            />
            <img
              src={OurCollaboratorImg4}
              alt=""
              className="max-md:w-[130px] max-md:h-[130px] max-sm:w-[60px] max-sm:h-[60px] max-[425px]:w-[60px] max-[425px]:h-[60px]"
            />
          </div>
