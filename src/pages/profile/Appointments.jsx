...
const Appointments = () => {
  ...
  const getAppointments = async () => {
    fetchData(
      `/patient/get-all-appointments?patientId=${userInfo?.userId}&status=${status}&date=${date ? format(new Date(date), "dd-MM-yyyy") : ""}&page=${currentPage}`,
    );
  };
  ...
  return (
    <ProfileLayout>
      <div className="bg-white rounded-lg p-5">
            ...
            <>
              ...
              >
                ...
                <div className="flex gap-3 justify-start items-center w-full -mt-[6px] -mb-3">
                  <p className="text-[#717171] text-[8px] font-medium font-inter">
                    Scheduled at
                  </p>
                  <p className="text-[#1A1A1A] text-[10px] font-normal font-inter">
                ...
                <button
                  ...
                  className="rounded-lg border-[1px] border-[#95C22B] text-[#95C22B] hover:bg-[#95C22B] hover:text-[#FFFFFF] h-8 px-2 flex justify-center items-center gap-[6px] w-full"
                >
        ...
        {allAppointments?.length === 0 && isLoading && <Spinner size={30} />}
