...
const Payment = () => {
  ...
  const getAppointments = async () => {
    ...
    fetchData(
      `/patient/patient-payment-history?patientId=${userInfo?.userId}&paymentFor=appointment&page=${currentPage}&status=${status === "all" ? "" : status}&date=${date || ""}`,
    );
  };
